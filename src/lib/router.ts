...
export const router = createRouterFromEnv({
  ...
  guidance: [
    ...
    "Audit:    POST /api/audit with {\"slug\": \"...\"} — ANYONE can fund the LLM audit of any listing: $0.15 for the first audit of an unaudited listing, $0.30 to re-audit one that already has a verdict (deters verdict re-rolling). Verdict/summary/capabilities are stamped on the listing; a rejecting audit delists the script.",
    "",
