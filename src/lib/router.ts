...
export const router = createRouterFromEnv({
  ...
  guidance: [
    ...
    "Audit:    POST /api/audit with {\"slug\": \"...\"} ($0.15) — ANYONE can fund the LLM audit of any listing. Verdict/summary/capabilities are stamped on the listing; a rejecting audit delists the script.",
    "",
