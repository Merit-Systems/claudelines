...
const GITHUB_REPO_URL = "https://github.com/Merit-Systems/claudelines";
const GITHUB_REPO_API =
  "https://api.github.com/repos/Merit-Systems/claudelines";
        ...
        <div className="flex items-center gap-2">
          ...
          <Button asChild variant="outline" size="sm">
            ...
            >
              ...
              {stars !== null && (
                <span
                  className="border-border ml-0.5 border-l pl-2 font-mono tabular-nums"
